...

{
  ...
  *(undefined1 (*) [64])((uint)fp & 0xffffffc0) = auVar2;
  ...
  auVar1._0_4_ = fp;
  Task_RegisterOrReplace(&LAB_0001ec70,4);
  ...
  Task_RegisterOrReplace(&LAB_0001f7e0,6);
  ...
  Task_RegisterOrReplace(&LAB_00025ca0,5);
  ...
  Task_RegisterOrReplace(&LAB_0002f5a0,7);
  ...
  Task_RegisterOrReplace(&LAB_0003e270,0xb);

...

{
  ...
  if (1 < (byte)((&g_player1)[param_1].action_state - 0x7_BLOCKSTUN)) {
    if (((&g_player1)[param_1].action_state != 0x9_HITSTUN) &&
       ((&g_player1)[param_1].action_state != 0xF_DOWNATTACKSTUN)) {
...
LAB_00025c50:
  ...
  uVar6 = ac & 0xfffffff8 | (uint)(DVar1 != 0x0_NEUTRAL) << 2 | (uint)(DVar1 == 0x0_NEUTRAL) << 1;
  if (DVar1 == 0x0_NEUTRAL) {

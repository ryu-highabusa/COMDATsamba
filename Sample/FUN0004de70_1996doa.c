...
void MotionDebug_SnapshotPlayersAndDrawAnimeId(void)

{
  ...
  if (((byte)ac & 1 | (byte)(uVar1 >> 2) & 1) != 1) {
    ...
    *(undefined1 (*) [64])((uint)fp & 0xffffffc0) = auVar2;
    ...
    FUN_0008e740(s_ANIME____04X_0004de60,(int)g_debug_anime_id_cached,uVar3,in_g3,uVar4,uVar5,uVar6,
                 uVar7,in_g8,in_g9,in_g10,in_g11);
    return;
  }

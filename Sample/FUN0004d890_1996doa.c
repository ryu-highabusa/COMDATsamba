  ...
  *(undefined1 (*) [64])((uint)fp & 0xffffffc0) = auVar4;
  ...
  do {
    ...
    *fp = auVar5;
    pauVar30 = pauVar29 + 1;
    FUN_00008250(1);
    iVar34 = (int)(char)g_motion_debug_render_mode;
    ...
    fp = pauVar27;
    uVar2 = ac;
    ac = ac & 0xfffffff8 | (uint)('\0' < (char)g_motion_debug_render_mode) << 2 |
         (uint)(g_motion_debug_render_mode == '\0') << 1 |
         (uint)((char)g_motion_debug_render_mode < '\0');
    if (((byte)ac & 1 | '\0' < (char)g_motion_debug_render_mode) == 1) {
      ...
      *fp = auVar13;
      ...
      if (((byte)(uVar2 >> 1) & 1) == 1) {
        ...
        *pauVar27 = auVar20;
        ...
        ac = uVar1 & 0xfffffff8 | (uint)('\0' < (char)g_motion_debug_render_mode) << 2 |
             (uint)(g_motion_debug_render_mode == '\0') << 1 |
             (uint)((char)g_motion_debug_render_mode < '\0');
        if (((byte)ac & 1 | '\0' < (char)g_motion_debug_render_mode) == 1) {

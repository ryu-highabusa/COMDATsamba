...

{
  ...
  if (Camera_Angle == camera_battle) {
LAB_00055e54:
    ac = ac & 0xfffffff8 | (uint)('\0' < (char)g_motion_debug_ui_toggle) << 2 |
         (uint)(g_motion_debug_ui_toggle == '\0') << 1 |
         (uint)((char)g_motion_debug_ui_toggle < '\0');
    if (((byte)ac & 1 | '\0' < (char)g_motion_debug_ui_toggle) != 1) {
    ...
    *(undefined1 (*) [64])(uVar30 + 0x40) = auVar9;
    ...
    g13 = 0xfa;
    ac = ac & 0xfffffff8 | (uint)(~camera_loadintoreplay < Camera_Angle);
    if (((byte)ac & 1 | Camera_Angle < ~camera_loadintoreplay) != 1) {
      ac = uVar31 & 0xfffffff8 | (uint)('\0' < (char)g_motion_debug_ui_toggle) << 2 |
           (uint)(g_motion_debug_ui_toggle == '\0') << 1 |
           (uint)((char)g_motion_debug_ui_toggle < '\0');
      if (((byte)ac & 1 | '\0' < (char)g_motion_debug_ui_toggle) != 1) {
      ...
      uVar31 = auVar3._4_4_ + 0x3f;
      puVar1 = (undefined1 *)(uVar31 & 0xffffffc0);
  ...
  uVar32 = (uint)CHAR_NUM_P1_00589e02;
  uVar30 = (uint)g_player1._0_4_ >> 8 & 0xff;
  uVar31 = ac & 0xfffffff8 | (uint)(uVar32 < uVar30) << 2 | (uint)(uVar32 == uVar30) << 1;
  ac = uVar31 | uVar30 < uVar32;
  auVar19._20_44_ = auVar3._20_44_;
  auVar19._0_16_ = auVar3._0_16_;
  auVar19._16_4_ = 0xff;
  if (((byte)(uVar31 >> 1) & 1) != 1) {
    uVar31 = auVar3._4_4_ + 0x3f;
    uVar32 = uVar31 & 0xffffffc0;
    ...
    *(undefined1 (*) [64])((uint)fp & 0xffffffc0) = auVar14;
    ...
    auVar13._0_8_ = CONCAT44(uVar31,fp) & 0xffffffc0ffffffff;
    Player_InitSecondaryMotionParts(uVar30,0);
    auVar16._12_52_ = auVar13._12_52_;
    auVar16._0_8_ = auVar13._0_8_;
    auVar16._8_4_ = 0x55ecc;
    *(undefined1 (*) [64])(uVar31 & 0xffffffc0) = auVar16;
    auVar15._8_56_ = auVar16._8_56_;
    auVar15._0_8_ = CONCAT44(uVar32 + 0x40,uVar31) & 0xffffffffffffffc0;
    FUN_0004f9e0(0);
    uVar31 = (uint)g_player1._0_4_ >> 8;
    auVar18._12_52_ = auVar15._12_52_;
    auVar18._0_8_ = auVar15._0_8_;
    auVar18._8_4_ = 0x55edc;
    *(undefined1 (*) [64])(uVar32 + 0x40) = auVar18;
    ...
    *(undefined1 (*) [64])(uVar32 + 0x80) = auVar20;
  ...
  if (((byte)(uVar31 >> 1) & 1) != 1) {
    ...
    *(undefined1 (*) [64])((uint)fp & 0xffffffc0) = auVar22;
    ...
    auVar21._0_8_ = CONCAT44(uVar31,fp) & 0xffffffc0ffffffff;
    Player_InitSecondaryMotionParts(uVar30,1);
    auVar24._12_52_ = auVar21._12_52_;
    auVar24._0_8_ = auVar21._0_8_;
    auVar24._8_4_ = 0x55f14;
    *(undefined1 (*) [64])(uVar31 & 0xffffffc0) = auVar24;
    auVar23._8_56_ = auVar24._8_56_;
    auVar23._0_8_ = CONCAT44(uVar32 + 0x40,uVar31) & 0xffffffffffffffc0;
    FUN_0004f9e0(1);
    uVar31 = (uint)g_player1._0_4_ >> 8;
    auVar26._12_52_ = auVar23._12_52_;
    auVar26._0_8_ = auVar23._0_8_;
    auVar26._8_4_ = 0x55f24;
    *(undefined1 (*) [64])(uVar32 + 0x40) = auVar26;
    ...
    *(undefined1 (*) [64])(uVar32 + 0x80) = auVar27;
  ...
  if ((ButtonCoinTestServiceStart_0054fcd4 & START_P2) == off) {
    g_motion_debug_ui_toggle = g_motion_debug_ui_toggle ^ 1;
    ac = uVar31;
  }
  auVar29._12_52_ = auVar19._12_52_;
  auVar29._0_8_ = auVar19._0_8_;
  auVar29._8_4_ = 0x55f58;
  *(undefined1 (*) [64])((uint)fp & 0xffffffc0) = auVar29;
  ...
  uVar31 = ac & 0xfffffff8 | (uint)((char)g_motion_debug_ui_toggle < '\0') << 2 |
           (uint)(g_motion_debug_ui_toggle == '\0') << 1;
  ac = uVar31 | '\0' < (char)g_motion_debug_ui_toggle;
  if (((byte)(uVar31 >> 1) & 1) != 1) {
    FUN_000085f0(&TMAPBASE_01000000);
    fp = (undefined1 *)(auVar19._4_4_ + 0x3fU & 0xffffffc0);
    return;
  }
  fp = (undefined1 *)auVar28._0_4_;
  return;
}

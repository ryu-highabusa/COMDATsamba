...
void FUN_00025940(uint param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  auVar7._24_4_ = (&g_character_act_record_table_candidate)[param_1 & 0xff];
    ...
    do {
      ...
      if ((((byte)ac & 1 | (byte)(uVar1 >> 1) & 1) == 1) ||
        ...
        *(undefined1 (*) [64])(fp & 0xffffffc0) = auVar10;
        ...
        auVar11._16_4_ = (param_1 & 0xff) * 0xc00 + auVar8._16_4_ * 0xc;
